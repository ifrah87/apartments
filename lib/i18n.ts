...
export const TRANSLATIONS: Record<Language, TranslationTree> = {
  en: {
    ...
    properties: {
      title: "Properties",
      description: "Overview, units, and tenants per building.",
      ...
      deleteConfirm: "Delete {name}? This will permanently remove all units and related leases/payments.",
      searchPlaceholder: "Search building, unit, or tenant",
      propertiesLoaded: "{count} properties loaded",
  ...
  so: {
    ...
    properties: {
      title: "Hantida",
      description: "Guudmar, unugyo, iyo deganeyaasha dhismo kasta.",
      addProperty: "Ku dar Hanti",
      nameRequired: "Magac ayaa loo baahan yahay.",
      created: "Hantida waa la sameeyay.",
      deleted: "Hantida waa la tirtiray.",
      createFailed: "Lama samayn karo hanti.",
      deleteFailed: "Lama tirtiri karo hanti.",
      deleteConfirm: "Ma tirtiraysaa {name}? Tani si joogto ah ayay uga saari doontaa dhammaan unugyada iyo heshiisyada/lacag-bixinnada la xiriira.",
      searchPlaceholder: "Raadi dhismo, unug, ama degane",
      propertiesLoaded: "{count} hanti ayaa la raray",
